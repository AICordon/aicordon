...
![email: lever by objective](figures/picket-0.3.0-20260813-184449-cells-email.svg)

![doc: lever by objective](figures/picket-0.3.0-20260813-184449-cells-doc.svg)

![web: lever by objective](figures/picket-0.3.0-20260813-184449-cells-web.svg)

![all carriers: lever by objective](figures/picket-0.3.0-20260813-184449-cells-all.svg)
...
![recall at a matched false-positive rate](figures/picket-0.3.0-20260813-184449-peers.svg)

### Recall by lever, at the same rate

![Recall by lever](figures/picket-0.3.0-20260813-184449-peers-family.svg)

### Recall by objective, at the same rate

![Recall by objective](figures/picket-0.3.0-20260813-184449-peers-action.svg)

Measured on this build but not in the comparison: `floor` — binary: its own point, it does not move to another's.
